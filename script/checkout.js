import { carts, removerProduct } from "../data/carts.js";
import { products } from "../data/products.js";
import { formatCurrency } from "./utils/money.js";

let itemContainer = document.querySelector(".js-order-summary");

carts.forEach((item) => {
	const productId = item.cartId;
	let productQuantity = item.quantity;

	//Check if productId 0f Product[] is the same as cartId of carts
	let matchingProduct;
	...
	let card = ``;
	card += `<div class="cart-item-container-${matchingProduct.id}">
